...
df.to_csv(r'dataBeforeTraining/pathImage112.csv', index=False)


list_data = []
data = pd.read_csv('dataBeforeTraining/pathImage112.csv')
X = data['path'].tolist()
Y = data['label'].tolist()
...
pickle.dump(le, open('dataBeforeTraining/decode_label_112.pkl', 'wb'))
pickle.dump(onehot_encoded, open("dataBeforeTraining/one_hot_label_112.pkl", "wb"))
pickle.dump(list_data, open('dataBeforeTraining/data_112.pkl', 'wb'))
